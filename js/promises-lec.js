...
// pokemonAPI.then((response) =>{response
//     .json()
...
// .then(results)+>(results.forEach((film)=> console.log(`${film.title} ${film.episode}`))
...
Promise.all([starWarsAPI, pokemonAPI]).then(responses)=>{console.log(responses);
})
