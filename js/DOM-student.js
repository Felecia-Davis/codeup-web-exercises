...
var dFlex = document.getElementsByClassName("d-flex");
console.log(dFlex);
...
var nameOfStore = document.getElementsByClassName("navbar-brand");

console.log(nameOfStore);
nameOfStore[0].innerText = "Davis'";
...
topSellers[0].innerHTML = "Fedora hats";
topSellers[1].innerHTML= "Cowboy hats";
topSellers[2].innerHTML = "Baseball hats";
for(var i = 0; i < topSellers.length; i++){
    console.log(topSellers[i].innerHTML);
}
...
for(var i = 0; i < specialOffer.length; i++) {
    console.log(specialOffer[i].innerHTML);
}for(var i = 0; i < specialOffer.length; i++) {
    console.log(specialOffer[i].innerHTML = "New discounts are coming soon!");
}
// attributes
...
var Demo2 = document.getElementById("navbarTogglerDemo02");
console.log(Demo2);
// var d = document.getElementById("navbar");
// var d_Demo2= document.getElementById("Demo2");
// var removedItem = d.removeChild(d_Demo2);
