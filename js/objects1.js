...
alert("Whoops, I forgot to tell you what year my vehicle was " + myCarYear + ".");
...
myCar.features =[ "heated/ventilated Seats", "leather", "towing package", "automatic startup"];
console.log(myCar);
...
//     sigotherCar
// ]
var theGarage = [myCar, myOtherCar];
...
theGarage.forEach(function(car){
    console.log("This is the make of the car: " + car.make);
    console.log("This is the model of the car: " + car.model);
    console.log("This is the year of the car: " + car.year);
})