...
// TODO TOGETHER: Change the color of the marker
    var marcoMarker= new mapboxgl.Marker({
        color: 'orange'})
            .setLngLat([-98.4861, 29.4260])
            .addTo(marcoMap)
...
var codeupSAMarker = new mapboxgl.Marker({
    color: 'rebeccapurple', draggable: true})
    .setLngLat([-98.4895, 29.4267])
    .addTo(marcoMap)
/**********************************************
 * 					POPUPS
...
//         .setLngLat ([-98.4895, 29.4267])
//         .setHTML ("<h6><em>Codup Rocks!</em></h6>")
//         .addTo(marcoMap)
//
...
//  geocode("600, San Antonio, TX 78205", mapboxToken).then(function(results){
//      console.log(results);
